INSERT INTO tabelaclientes (ID_cliente, nome_cliente, Infos_de_contato, Endereco_Cliente) VALUES
...
ALTER TABLE tabelaclientes ADD Endereço_cliente VARCHAR (150);

UPDATE tabelapedidos SET Status = 'Enviado' WHERE Status = 'Processando';

UPDATE tabelaclientes SET infos_de_contato = 'j.santos@email.com',
...
INSERT INTO tabelaprojetos (ID_projeto, Nome_do_projeto, id_gerente)  
VALUES  
(1, 'Sistema de Automação Financeira', 3),  
(2, 'Plataforma de E-commerce', 5),  
(3, 'Aplicativo de Gestão de Vendas', 8);